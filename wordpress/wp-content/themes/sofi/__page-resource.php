	...
	<div id="resources">
		<div class="medium-3 columns">
			<div id="filters">
				...
				// The Query
				$resource_cats_query = new WP_Query( $args );
				if ( $resource_cats_query->have_posts() ) {
					$i = 0;
					while ( $resource_cats_query->have_posts() ) {
						$resource_cats_query->the_post();
						?>

						<div class="resource-filter <?php if ( $i === 0 ) { echo 'active'; } ?>" cat="<?php the_time( Y ); ?>"><?php the_time( Y ); ?> Resources</div>
